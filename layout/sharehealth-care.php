<?php
$page_url = "https://parnav.org/health-care.php";
?>
<style>
    .title {
        z-index: 999;
...
<div class="modal fade" id="sharehealth-care" tabindex="-1" aria-labelledby="sharehealth-care" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="https://parnav.org/health-care.php" id="copy">
                                </div>

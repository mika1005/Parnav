<?php
$page_url = "https://parnav.org/livelihood.php";
?>
<style>
    .title {
        z-index: 999;
...
<div class="modal fade" id="sharelivelihood" tabindex="-1" aria-labelledby="sharelivelihood" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="https://parnav.org/livelihood.php" id="copy">
                                </div>

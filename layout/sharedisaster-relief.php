<?php
$page_url = "https://parnav.org/disaster-relief.php";
?>
<style>
    .title {
        z-index: 999;
...
<div class="modal fade" id="sharedisaster-relief" tabindex="-1" aria-labelledby="sharedisaster-relief" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="https://parnav.org/disaster-relief.php" id="copy">
                                </div>

<?php
$page_url = "https://parnav.org/education.php";
?>
<style>
    .title {
        z-index: 999;
...
<div class="modal fade" id="shareeducation" tabindex="-1" aria-labelledby="shareeducation" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="https://parnav.org/education.php" id="copy">
                                </div>

...
include("config.php");
    ...
    if (isset($_POST['submit'])) {
        ...
        $query="INSERT INTO `joining`(
            `name`, `email`,`number`,`joining`,`address`)
     ...
     if( $run = mysqli_query($connection,$query));{
        $submitSuccess='  
        <h2 style="color:black;">Data entered successfully ! Soon we will contact you</h2>';
        if(isset( $submitSuccess)) 
echo   " <center>   $submitSuccess</center>";
...
<select class="form-select fmt-3" style="width: 100%; name="joining" id="Join" required>
<option value="">Join Us As</option>
                             <option value="Member">Member</option>
                             <option value="Blood Bank ">Blood Bank</option>
                             <option value="Blood Coordinator">Blood Coordinator</option>
                             <option value="Sponsor">Sponsor</option>
   </select>
<br>
<div class="form-group ">
      <label for="address">Address With Pin code:</label>
